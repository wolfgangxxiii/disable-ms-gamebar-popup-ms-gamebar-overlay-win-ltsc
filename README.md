...
Najczęściej problem pojawia się w grach, emulatorach, aplikacjach fullscreen, a także podczas podłączania kontrolera (gamepada) w systemach LTSC.
...
The issue most commonly occurs in games, emulators, fullscreen applications, when connecting a controller (gamepad) in LTSC systems.
